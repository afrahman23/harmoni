...
/system scheduler
add interval=1d name=daily_backupfile on-event="# ftp config -!change the vari\
    ables only here!-\r\
    \n:local ftpip \"192.168.xx.xx\";\r\
    \n:local ftpuser \"mikro\";\r\
    \n:local ftppass \"good\";\r\
    \n:local fport \"2122\";\r\
    \n:local ftppath \"/NetBackup/mikrotikcore/\";\r\
    \n:local bot \"1423232020:AAE7PxeXQOcjUUg_Nehm_-dkfkHkdkd8G2g\";\r\
    \n:local chat \"-414761678\";\r\
    \n\r\
    ...
    \n/tool fetch address=\"\$ftpip\" port=\"\$fport\" mode=ftp upload=yes use\
    r=\"\$ftpuser\" password=\"\$ftppass\" src-path=(\"\$backupfile.rsc\") dst\
    -path=(\"\$ftppath\$backupfile.rsc\");\r\
    \n# message success to log\r\
    \n:log info message= (\"\$backupfile.rsc has been successfully uploaded to\
    \_FTP!\");\r\
    \n\r\
    \n/tool fetch address=\"\$ftpip\" port=\"\$fport\" mode=ftp upload=yes use\
    r=\"\$ftpuser\" password=\"\$ftppass\" src-path=(\"\$backupfile.backup\") \
    dst-path=(\"\$ftppath\$backupfile.backup\");\r\
    \n# message success to log\r\
    ...
    start-date=dec/16/2022 start-time=23:50:50
